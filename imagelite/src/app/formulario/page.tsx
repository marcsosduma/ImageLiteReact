...
import { Button, InputText, RenderIf, Template, useNotification, FieldError, AuthenticatePage } from '@/components'
                                ...
                                <div className='mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10'>
                                    <div className='text-center'>
                                        ...
                                        <div className='mt-4 flex text-sm leading-6 text-gray-600'>
                                            <label className="flex flex-col items-center gap-2 cursor-pointer rounded-md bg-white font-semibold text-indigo-600">
                                                <RenderIf condition={!imagePreview}>
