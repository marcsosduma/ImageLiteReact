...
const Loading: React.FC = () => {
    return (
        <div className='flex items-center justify-center h-screen w-full' role="status">
    ...
    return (
        <header className="bg-indigo-950 text-white py-3">
            <div className="container mx-auto flex justify-between items-center px-4">
                ...
                <RenderIf condition={user !== null}>
                    <div className="flex items-center">
                        <div className="flex items-center gap-4 text-md">
                            <span>
                                Olá, {user?.name}
                            </span>
                            <span className="text-sm text-neutral-tertiary hover:underline">
        ...
        <>
            <footer className="bg-indigo-950 text-white py-4 mt-8">
                <div className="container mx-auto text-center">
                    Desenvolvido por Marcos Martins Duma
